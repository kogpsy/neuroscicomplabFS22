...
x <- read.table("_do_not_build/shift_function/onset.csv")
twoses <- scan("_do_not_build/shift_function/onset_twoses.csv")
ses1 <- x[twoses==1,3]
# ses2 contains onsets from 74 participants who also provided ses1 onsets
x <- read.table("_do_not_build/shift_function/onset2.csv")
ses2 <- x[,3]
