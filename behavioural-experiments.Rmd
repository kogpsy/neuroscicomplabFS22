...
The dots were presented on a 51.3-cm-wide LCD screen at a viewing distance of 50 cm. In the scanner session, the dots were presented on a 61-cm-wide projection screen using a projector with a resolution of 1920 x 1200 (GeForce 9500 GT graphical card) and adjusted to match the same diameter (5°) as the session outside the scanner.
...
Ein Trial besteht aus einer oder mehreren Routines.
