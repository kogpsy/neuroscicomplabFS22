...
style_duo_accent(
  ...
  # inverse_header_color = "#FFFFFF",
  # primary_color      = "#434C5E", # Nord theme
...
<div class="my-footer">
<span>
<a href="https://kogpsy.github.io/neuroscicomplabFS22" target="_blank">`r fontawesome::fa(name = "home", fill = "#0F4C81")`</a> Neurowissenschaft im Computerlab FS22
</span>
</div>
