...
In dieser Aufgabe bearbeiten Sie Daten aus einem Detektionssexperiment. Versuchspersonen mussten in zwei Bedingungen (_Bias_ und _No Bias_) ein Signal, welches in Rauschen eingebettet war, detektieren. Im Datensatz sind folgende Variablen:
...
c) Überprüfen Sie, ob alle Variablen vorhanden sind. Verwenden Sie z.B. die Funktion _glimpse()_

d) Konvertieren Sie die Gruppierungsvariablen _subject_ und _condition_ zu Faktoren.
:::
