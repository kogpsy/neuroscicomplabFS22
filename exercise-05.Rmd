...
Von Interesse sind die Reaktionszeiten der _korrekten_ Antworten in den Bedingungen _kongruent_, _inkongruent_ und _neutral_.
...
:::exercise
1) Untersuchen Sie mittels einer _Shift Function_ den Unterschied zwischen den Bedingungen `congruent` und `incongruent`. 
...
Stellen Sie die _Shift Function_ grafisch dar.
