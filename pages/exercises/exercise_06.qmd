...
:::{.callout-note}
Die Daten für diese Übung finden Sie hier: 👉 [Download Data](../../data/exercise-06/data/ddm-data.csv)
...
Laden Sie bitte Ihre Lösung als R Skript bis **Mittwoch, 17.5.2022, um 00:30 Uhr**, in den Order für Übung 6 auf ILIAS.
...
```{r}
data1 <- rdiffusion(n = 100, a = 0.2, v = 0.3, t0 = 0.5, z = 0.7 * 2, s = 0.1) # simulate data
data2 <- rdiffusion(n = 100, a = 0.2, v = -0.3, t0 = 0.5, z = 0.3 * 2, s = 0.1) # simulate data
...
# }
init_params <- function() {
 params <- c(a = abs(runif(1, 0.5, 0.1)),
