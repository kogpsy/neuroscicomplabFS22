...
# ╔═╡ 87cb68d8-a96a-11ec-0ebc-2161eb8ba350
using Distributions, CairoMakie, PlutoUI

# ╔═╡ 7c11929d-37c6-42d5-9da2-ecb9533dd615
dprime = @bind dprime PlutoUI.Slider(0.5:10, default = 1.5)

# ╔═╡ d4398887-2aae-4631-a879-5c24da7254ae
c = @bind c PlutoUI.Slider(-5:1:5, default = 0)

# ╔═╡ 229a25c0-25c5-4a62-9c73-5a179b5dc1be
begin
	d_noise = Normal(0, 1)
	d_signal = Normal(dprime, 1)
